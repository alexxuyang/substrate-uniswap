...
fn swap_tests() {
	new_test_ext().execute_with(|| {
		...
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 21000000);
		...
		assert_eq!(TokenModule::balance_of((alice, token2.token_hash)), 10000000);
		...
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 20000000);
		...
		assert_ok!(SwapModule::do_create_trade_pair(alice, token1.token_hash, token2.token_hash));
		let tp_hash = SwapModule::trade_pair_hash_by_base_quote((token1.token_hash, token2.token_hash)).unwrap();
		...
		// alice add liquidity
		assert_ok!(SwapModule::do_add_liquidity(alice, tp.tp_hash, 100, Some(100 * 300))); // 100 eth & 30000 usdt
		...
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 19999900); // 20000000 - 100
		...
		assert_eq!(TokenModule::balance_of((alice, tp.liquidity_token_hash)), 100);
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 19999900);
		...
		assert_eq!(TokenModule::balance_of((tp.account, token1.token_hash)), 600);    // 100 + 500
		assert_eq!(TokenModule::balance_of((tp.account, token2.token_hash)), 180000); // 100 * 300 + 500 * 300
		...
		assert_eq!(TokenModule::balance_of((alice, tp.liquidity_token_hash)), 100);
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 19999887); // 19999900 - 13
		...
		assert_eq!(TokenModule::balance_of((tp.account, tp.liquidity_token_hash)), u128::max_value() - 600);
		assert_eq!(TokenModule::balance_of((tp.account, token1.token_hash)), 613);    // 600 + 13
		assert_eq!(TokenModule::balance_of((tp.account, token2.token_hash)), 176183); // 180000 - 3817
		...
		assert_eq!(TokenModule::balance_of((tp.account, tp.liquidity_token_hash)), u128::max_value() - 600);
		assert_eq!(TokenModule::balance_of((tp.account, token1.token_hash)), 612);    // 613 - 1
		assert_eq!(TokenModule::balance_of((tp.account, token2.token_hash)), 176722); // 176183 + 539
		...
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 19999410); // 19999887 - 477
		...
		assert_eq!(TokenModule::balance_of((tp.account, token1.token_hash)), 1089);    // 612 + 477
		assert_eq!(TokenModule::balance_of((tp.account, token2.token_hash)), 314461);  // 176722 + 137739
		...
		assert_eq!(TokenModule::balance_of((tp.account, token1.token_hash)), 579);    // 1089 - 510
		assert_eq!(TokenModule::balance_of((tp.account, token2.token_hash)), 167104);  // 314461 - 147357
		...
		assert_eq!(TokenModule::balance_of((alice, tp.liquidity_token_hash)), 0);
		assert_eq!(TokenModule::balance_of((alice, token1.token_hash)), 19999989); // 19999410 + 579
